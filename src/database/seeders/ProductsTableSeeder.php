    ...
    public function run()
    {
        ...
        $products = [
            ...
            [
                'name' => 'ストロベリー',
                'price' => '1200',
                'image' => 'sample_images/strawberry.png',
            ...
            [
                'name' => 'オレンジ',
                'price' => '850',
                'image' => 'sample_images/orange.png',
            ...
            [
                'name' => 'スイカ',
                'price' => '700',
                'image' => 'sample_images/watermelon.png',
            ...
            [
                'name' => 'シャインマスカット',
                'price' => '1400',
                'image' => 'sample_images/muscat.png',
            ...
            [
                'name' => 'パイナップル',
                'price' => '800',
                'image' => 'sample_images/pineapple.png',
            ...
            [
                'name' => 'ブドウ',
                'price' => '1100',
                'image' => 'sample_images/grapes.png',
            ...
            [
                'name' => 'バナナ',
                'price' => '600',
                'image' => 'sample_images/banana.png',
        ...
        foreach ($products as $productData) {
            ...
            // 指定した季節IDに紐づけ
            $seasonIds = array_map(fn($name) => $seasonMap[$name], $seasonNames);
